...
The project simulates the investigation workflow used by Security Operations Center (SOC) analysts when responding to identity security alerts within Microsoft cloud environments.

The scenarios documented in this repository include authentication attacks, credential compromise activity, suspicious login patterns, and data exfiltration behavior.
...
These queries analyze log data from sources such as:
...
These detections simulate the types of alerts generated by SIEM platforms in enterprise environments.

---

## 2 Evidence Collection

Once suspicious activity is detected, relevant log activity is collected and documented as supporting evidence.
...
These playbooks describe the containment and mitigation procedures used to respond to identity based attacks.
...
# Why Kusto Query Language Is Used
...
| Impossible Travel Login Remediation | Investigation procedures for logins originating from geographically distant locations within a short timeframe | https://github.com/jwnfld3/enterprise-identity-incident-investigation/blob/main/playbooks/impossible-travel-login-remediation.md |
...
| Phishing Attack Remediation | Investigation procedures for phishing based authentication attempts targeting user credentials | https://github.com/jwnfld3/enterprise-identity-incident-investigation/blob/main/playbooks/phishing-attack-remediation.md |
