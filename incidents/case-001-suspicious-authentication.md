...
Time (UTC) | Event
--- | ---
09:10 | Suspicious authentication attempts detected
09:12 | Multiple failed login attempts recorded
09:15 | Conditional Access policy blocked authentication attempt
09:18 | Security alert generated in Microsoft Sentinel
...
--- | --- | ---
User Account | jsmith@company.com | Targeted account involved in suspicious authentication attempts
IP Address | 185.193.xxx.xxx | Foreign IP address associated with failed authentication attempts
Authentication Method | Password Authentication | Repeated password-based authentication attempts observed
Application Access | Microsoft 365 | Authentication attempts targeting cloud services
...
These techniques are commonly associated with credential access attempts targeting enterprise identity systems.
...
Require Multi Factor Authentication for authentication attempts originating from unfamiliar locations and block high-risk geographic regions when possible.

### Implement Identity Protection Policies

Enable automated identity protection controls that detect high-risk sign-in attempts and require password reset for compromised accounts.

### Monitor Authentication Anomalies

Deploy detection rules within Microsoft Sentinel that alert analysts when authentication anomalies occur.

### Improve User Security Awareness

Provide security awareness training to help users recognize suspicious authentication activity and potential credential attacks.
